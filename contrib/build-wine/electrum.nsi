...
;Variables
  ...
  !define PRODUCT_NAME "Electrum-Actinium"
  !define PRODUCT_WEB_SITE "https://github.com/zcoinofficial/electrum-actinium"
...
;General
  ...
  ;Name and file
  Name "${PRODUCT_NAME}"
  OutFile "dist/electrum-actinium-setup.exe"
...
;Interface Settings
  ...
  !define MUI_ICON "tmp\electrum-actinium\icons\electrum.ico"
...
Section
  ...
  CreateShortCut "$DESKTOP\${PRODUCT_NAME}.lnk" "$INSTDIR\electrum-actinium-${PRODUCT_VERSION}.exe" ""

  ;Create start-menu items
  DetailPrint "Creating start-menu items..."
  CreateDirectory "$SMPROGRAMS\${PRODUCT_NAME}"
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\Uninstall.lnk" "$INSTDIR\Uninstall.exe" "" "$INSTDIR\Uninstall.exe" 0
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME}.lnk" "$INSTDIR\electrum-actinium-${PRODUCT_VERSION}.exe" "" "$INSTDIR\electrum-actinium-${PRODUCT_VERSION}.exe" 0
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${PRODUCT_NAME} Testnet.lnk" "$INSTDIR\electrum-actinium-${PRODUCT_VERSION}.exe" "--testnet" "$INSTDIR\electrum-actinium-${PRODUCT_VERSION}.exe" 0
  ...
  WriteRegStr HKCU "Software\Classes\actinium\shell\open\command" "" "$\"$INSTDIR\electrum-actinium-${PRODUCT_VERSION}.exe$\" $\"%1$\""
